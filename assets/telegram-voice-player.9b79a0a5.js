 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Lt=(s,t)=>t.kind==="method"&&t.descriptor&&!("value"in t.descriptor)?Z(X({},t),{finisher(e){e.createProperty(t.key,s)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){typeof t.initializer=="function"&&(this[t.key]=t.initializer.call(this))},finisher(e){e.createProperty(t.key,s)}};function y(s){return(t,e)=>e!==void 0?((i,o,r)=>{o.constructor.createProperty(r,i)})(s,t,e):Lt(s,t)}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var V;((V=window.HTMLSlotElement)===null||V===void 0?void 0:V.prototype.assignedElements)!=null;function ht(s){const t=Math.floor(s/60),e=Math.floor(s-t*60);return`${String(t).padStart(2,"0")}:${String(e).padStart(2,"0")}`}function zt(s,t){const e=s.getChannelData(0),i=Math.floor(e.length/t),o=[];for(let r=0;r<t;r++){let n=0;const h=i<16?i:16;for(let a=0;a<h;a++){const l=Math.floor(Math.random()*i)+r*i;n+=Math.abs(e[l])}o.push(n/h)}return o}function Dt(s){const t=Math.pow(Math.max(...s),-1);return s.map(e=>e*t)}function N(s,t,e=""){const i=s.getRootNode()instanceof ShadowRoot?s.firstElementChild:s;return window.getComputedStyle(i).getPropertyValue(`--${t}`)||e}function dt(s){const t=window.devicePixelRatio||1;s.width=s.offsetWidth*t,s.height=s.offsetHeight*t,s.getContext("2d").scale(t,t)}async function ct(s,t,e,i,{async:o=!0,mirror:r=!1,round:n=!0,minHeight:h=0}={}){const a=t.length;let l=s.offsetWidth/a;const v=l*e,d=l-v;l+=v/a;const c=s.getContext("2d");c.save(),c.translate(0,r?s.offsetHeight/2:s.offsetHeight);for(let p=0;p<a;p++){const _=l*p,g=r?s.offsetHeight/2:s.offsetHeight;let m=t[p]*s.offsetHeight;r&&(m/=2),m<h*g?m=h*g:n&&m+d/2>g?m=g-d/2:m>g&&(m=g),o&&await It(),c.globalCompositeOperation="source-over",c.fillStyle=i,c.clearRect(_,g*-1,l,r?g*2:g),c.fillRect(_,m*-1,d,r?m*2:m),n&&(c.beginPath(),c.arc(_+d/2,m*-1,d/2,0,Math.PI*2),r&&c.arc(_+d/2,m,d/2,0,Math.PI*2),c.fill())}c.restore()}function It(){return new Promise(s=>{requestAnimationFrame(()=>{s(!0)})})}var jt=O`
...
`,qt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,$=(s,t,e,i)=>{for(var o=i>1?void 0:i?Kt(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(o=(i?n(t,e,o):n(o))||o);return i&&o&&qt(t,e,o),o};let f=class extends k{constructor(){super(...arguments);this.src="",this.bars=64,this.mirroredBars=!0,this.initiated=!1,this.isPlaying=!1,this.totalTime=234,this.currentTime=0,this.isPending=!0,this.hasLoaded=!1,this.hasError=!1,this.audio=new Audio}render(){return O`
      <div id="container">
        <button id="play" @click=${this._playOrPause} ?disabled=${!this.hasLoaded}>
          ${this.isPending?Wt:this.isPlaying?Vt:jt}
        </button>
        <div id="details">
  ...
  `;$([y({type:String})],f.prototype,"src",2);$([y({type:Number,reflect:!0})],f.prototype,"bars",2);$([y({type:Boolean,reflect:!0})],f.prototype,"mirroredBars",2);$([y({type:Boolean,attribute:!1})],f.prototype,"initiated",2);$([y({type:Boolean,attribute:!1})],f.prototype,"isPlaying",2);$([y({type:Number,attribute:!1})],f.prototype,"totalTime",2);$([y({type:Number,attribute:!1})],f.prototype,"currentTime",2);$([y({type:Boolean,attribute:!1})],f.prototype,"isPending",2);$([y({type:Boolean,attribute:!1})],f.prototype,"hasLoaded",2);$([y({type:Boolean,attribute:!1})],f.prototype,"hasError",2);$([y({attribute:!1})],f.prototype,"audio",2);$([y({attribute:!1})],f.prototype,"audioBuffer",2);f=$([Bt("telegram-voice-player")],f);export{f as TelegramVoicePlayer};
